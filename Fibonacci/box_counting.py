...
qRange = np.arange(-10.,0.,0.1)

# list containing the linear regression data
lin_reg = []

filename = "data/tauqpsi_box_counting.dat"
...
## convert to string
#slin_reg = str(lin_reg)
## translate for Mathematica
#transl_table = slin_reg.maketrans('[]()','{}{}')
#file.write(slin_reg.translate(transl_table))
#file.close()